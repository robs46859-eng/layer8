...
class Settings(BaseSettings):
    ...
    audit_backend: str = Field(default="aws", alias="AUDIT_BACKEND")
    azure_blob_account_url: str = Field(default="", alias="AZURE_BLOB_ACCOUNT_URL")
    azure_blob_container: str = Field(default="audit", alias="AZURE_BLOB_CONTAINER")
    azure_service_bus_namespace: str = Field(default="", alias="AZURE_SERVICE_BUS_NAMESPACE")
    azure_service_bus_queue: str = Field(default="", alias="AZURE_SERVICE_BUS_QUEUE")
